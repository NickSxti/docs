...
Qonversion sends [subscription events](/docs/integrations-overview#tracked-events) to AppMetrica to help you match your users' behavior with their payment history and inform your product decisions.
