...
Learn more about [variant configuration](https://documentation.qonversion.io/docs/launch-experiments#2-configure-and-test-variants).
...
* And [other options](https://documentation.qonversion.io/docs/launch-experiment#segment-users).
...
Learn more about how we help [analyse experiments](https://documentation.qonversion.io/docs/analyse-experiment).
