...
Qonversion allows you to upload all the raw revenue data we track to your Amazon S3 bucket. You can find more details about raw data reports [here](/docs/scheduled-reports).
...
4. Congratulation! Now you have successfully connected the Amazon S3 bucket to Qonversion. Navigate to the [Scheduled reports section](/docs/scheduled-reports#amazon-s3) to launch report uploading to the bucket.
