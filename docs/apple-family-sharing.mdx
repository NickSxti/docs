...
Qonversion [Subscription Management mode](https://documentation.qonversion.io/docs/subscription-management-mode) supports Family Sharing out-of-the-box. You just need to set up [your products and entitlements](https://documentation.qonversion.io/docs/subscription-management-mode#1-configure-products--entitlements). Family Sharing will be available automatically.
