...
4. Grant this service account access to the project by enabling:
   ...
   * **Pub/Sub Admin** (to enable [Google Developer Notifications](doc:google-developer-notifications)) ![](/images/docs/11ebf5e-PubSub_Admin.png)
