...
<Info>
  ...
  Please do not confuse them with [Apple Introductory Offers](https://developer.apple.com/documentation/storekit/in-app_purchase/original_api_for_in-app_purchase/subscriptions_and_offers/implementing_introductory_offers_in_your_app) and [App Store Promoted Purchases](/docs/app-store-promoted-purchases), which are used for new users and for promoting your products through the App Store, respectively.
</Info>
