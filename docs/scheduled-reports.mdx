...
Scheduled reports allow you to automate [raw data export](/docs/raw-data-reports). It is helpful to:
...
1. Create a Google Cloud Storage destination accordingly to the [integration guide](/docs/google-cloud-storage)
...
1. Create an Amazon S3 destination accordingly to the [integration guide](/docs/amazon-s3)
2. Navigate to the [Scheduled Reports tab](https://dash.qonversion.io/scheduled-reports) and click the **Create** button.
...
1. Create a Webhook destination accordingly to the [Webhook integration guide](/docs/webhooks)
2. Navigate to the [Scheduled Reports tab](https://dash.qonversion.io/scheduled-reports) and click the **Create** button.
...
| project\_key | Your Qonversion [project key](/docs/getting-started)      |
...
1. Create a Slack destination accordingly to the [Slack integration guide](/docs/slack)
2. Navigate to the [Scheduled Reports tab](https://dash.qonversion.io/scheduled-reports) and click the **Create** button.
