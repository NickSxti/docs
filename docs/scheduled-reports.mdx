...
Scheduled reports allow you to automate [raw data export](doc:raw-data-reports). It is helpful to:
...
1. Create a Google Cloud Storage destination accordingly to the [integration guide](https://documentation.qonversion.io/docs/google-cloud-storage)
...
1. Create an Amazon S3 destination accordingly to the [integration guide](https://documentation.qonversion.io/docs/amazon-s3)
2. Navigate to the [Scheduled Reports tab](https://dash.qonversion.io/scheduled-reports) and click the **Create** button.
...
1. Create a Webhook destination accordingly to the [Webhook integration guide](https://documentation.qonversion.io/docs/webhooks)
2. Navigate to the [Scheduled Reports tab](https://dash.qonversion.io/scheduled-reports) and click the **Create** button.
...
| project\_key | Your Qonversion [project key](doc:getting-started)      |
...
1. Create a Slack destination accordingly to the [Slack integration guide](https://documentation.qonversion.io/docs/slack)
2. Navigate to the [Scheduled Reports tab](https://dash.qonversion.io/scheduled-reports) and click the **Create** button.
3. Fill in all the required fields, select Slack as the destination, and then click the **Create** button again.

![](/images/docs/2ea8519-Screenshot_2022-12-22_at_16.35.04.png "Screenshot 2022-12-22 at 16.35.04.png")
