...
<Warning>
  Note, please, that the entitlement object is available only in case the user has made a purchase, or you granted the entitlement manually using [the Customer tab](/docs/customers#edit-entitlements) or Grant Entitlement API. In other cases, you will receive an empty result.
</Warning>
