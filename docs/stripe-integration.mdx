...
A product can have multiple prices — more about setting up Stripe products in [Stripe official documentation](https://stripe.com/docs/billing)
...
<Info>
  Skip this step if you are not using the [Qonversion Subscription Management mode](https://documentation.qonversion.io/docs/subscription-management-mode).
</Info>
...
3. Send your Stripe purchase result to Qonversion via the [API endpoint](https://documentation.qonversion.io/reference/create-a-purchase).
