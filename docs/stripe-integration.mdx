...
<Info>
  Skip this step if you are not using the [Qonversion Subscription Management mode](/docs/subscription-management-mode).
</Info>
...
3. Send your Stripe purchase result to Qonversion via the [API endpoint](/reference/overview).
