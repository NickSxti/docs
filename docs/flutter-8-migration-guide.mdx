---
title: "Flutter SDK 7.x to 8.x migration guide"
...
* The `QProrationMode` enum was removed and replaced with `QPurchaseUpdatePolicy` ([read more](/docs/making-purchases)).

***

[Android SDK 6.x to 7.x migration guide](/docs/android-7-migration-guide)
