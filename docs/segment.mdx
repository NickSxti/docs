...
3. Attribute events sent from Qonversion and events received from the Segment SDK to the same user by setting the same user id to Segment that you set to Qonversion SDK in the [User Identifiers guide](https://documentation.qonversion.io/docs/user-identifiers#2-user-id-for-third-party-integrations).
