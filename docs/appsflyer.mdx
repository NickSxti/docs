...
3. Send AppsFlyer user ID to Qonversion via [User Properties](/docs/user-properties). In the **onConversionDataSuccess** callback use the`setProperty()` method with the AppsFlyer user ID value.
