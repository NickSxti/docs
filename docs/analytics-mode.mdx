...
1. Check whether you have set your products up correctly. Make your GooglePlay subscriptions backwards compatible to have the best possible accuracy in Qonversion. [Learn more here](https://documentation.qonversion.io/docs/android-in-app-products)
...
* Guide on [Apple Server-to-Server Notifications](https://documentation.qonversion.io/docs/server-to-server-notifications)
* Guide on [Google Developer Notifications](https://documentation.qonversion.io/docs/google-developer-notifications)
