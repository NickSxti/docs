...
* "Observe" mode becomes [Analytics mode](https://documentation.qonversion.io/docs/analytics-mode),
* "Infrastructure" mode becomes [Subscription Management mode](https://documentation.qonversion.io/docs/subscription-management-mode).
