...
Qonversion can send [revenue events](https://documentation.qonversion.io/docs/integrations-overview#tracked-events), including purchases, trial conversions, subscription renewals, and even refunds, to your Firebase account. This allows you to match your users' behaviour with their payment history in Firebase and empower your product decisions.
...
3. Send *firebaseAppInstanceId* to Qonversion via [User Properties](doc:user-properties)
