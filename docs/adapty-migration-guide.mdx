...
1. **App-Specific Shared Secret**: Copy this value from the App Store Connect shared secret field in the App Settings -> iOS SDK section in the Adapty dashboard. [Here's](https://documentation.qonversion.io/docs/app-specific-shared-secret) a more detailed guide on how to obtain this.
...
![](/images/docs/a4edbc84020939b3e23a7b3de6bab82c3369e1ae62c465d8a516a995d0008359-3d4087e-CleanShot_2023-06-26_at_13.27.042x.png)

### Google Play Console Settings

Here's what you have at Adapty:

![](/images/docs/bfda19a41b310706c90e123a302abf8e3a2b75ba90a09428f4cc5ddbd5e82a9e-f6d76ec-app-settings_android.png)
...
2. **Service Account Credentials JSON**: Copy the value from the **Service account key file** shown in the screenshot above, or attach the same file you used with Adapty. [Here's more](https://documentation.qonversion.io/docs/service-account-key-android) on how you can get Google Play Service Account Key.
...
![](/images/docs/ec88638205dd4625aeadabc72b7c0b9f03f8e85d69daec6bf21b66c62d1ab1c3-5b2bc83-access_levels.png)
...
![](/images/docs/0b9bd1bdced74eff31427ced60179a10dd13861695a89e4871f085136d9dabf4-7c9573a-products_tab.png)
...
* **Google Play Product ID** – product identifier on Google Play Console. Learn more on how to set up [Android in-app products ](https://documentation.qonversion.io/docs/android-in-app-products).
...
See more information [here](https://documentation.qonversion.io/docs/server-to-server-notifications).
...
It takes up to 24 hours for your [Google service credentials](https://documentation.qonversion.io/docs/service-account-key-android) to work correctly. Make sure to wait for at least 24 hours after you have created the credentials before connecting to Google Real-Time Developer Notifications.

See more information [here](https://documentation.qonversion.io/docs/google-developer-notifications).

# Install SDKs

Check out the links below for the SDK you need and follow the steps provided:

→ [iOS SDK](doc:ios-sdk-setup) → [Android SDK](doc:android-sdk) → [Flutter SDK](doc:flutter-sdk) → [React Native SDK](doc:react-native-sdk) → [Unity SDK](doc:unity-sdk) → [Cordova Plugin](doc:cordova) → [Capacitor Plugin](doc:capacitor) → [Web](doc:web-sdk) → [Kids Mode Qonversion SDKs](doc:kids-mode-sdk)

Read more about [Installing the SDKs](https://documentation.qonversion.io/docs/install-sdk).
...
[See more about Offerings](https://documentation.qonversion.io/docs/offerings)
...
1. Prepare files with [AppStore with Base64 encoded receipt data](https://documentation.qonversion.io/docs/migrating-subscriptions#app-store-data-migration-file) or [Google Play with purchase tokens](https://documentation.qonversion.io/docs/migrating-subscriptions#google-play-data-migration-file). If you do not have receipt data or purchase tokens on your side but are already running your subscription management with a third-party vendor, you should ask the vendor’s support team for the required data file.
...
[Migrating from RevenueCat](/docs/migrating-from-revenuecat-to-qonversion)
