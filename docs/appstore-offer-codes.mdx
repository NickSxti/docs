...
If you need to get the results immediately after a user enters a promo code, please check the [deferred purchases](https://documentation.qonversion.io/docs/deferred-purchases) documentation. If a promo code was successfully applied, `checkEntitlements()` returns the updated entitlements.
