...
* The `syncHistoricalData` method has been deprecated, as it can't completely fulfill its purpose anymore. If you relied on this method for migrating your userbase purchases history to Qonversion, you will no longer be able to do so following this major update. For other available options, please refer to [our documentation](/docs/migrating-subscriptions#/).
