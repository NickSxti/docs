...
Qonversion allows you to upload all the raw revenue data we track to your Google Cloud Storage bucket. You can find more details about raw data reports [here](/docs/scheduled-reports).
...
4. Congratulation! Now you have successfully connected the Google Cloud Storage bucket to Qonversion. Navigate to the [Scheduled reports section](/docs/scheduled-reports#google-cloud-storage) to launch report uploading to the bucket.
