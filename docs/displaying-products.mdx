...
<Check>
  ...
  [Qonversion SDK caches the data on products, offerings, and entitlements](/docs/offline-sdk-mode). This data is available when the internet connection is lost or there are server-side delays. Every time your application launches, SDK requests actual SkProduct/SkuDetails from the App Store or Google Play to get the most up-to-date product data.
</Check>
