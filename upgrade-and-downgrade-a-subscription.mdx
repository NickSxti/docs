...
In order to perform upgrading, downgrading, or changing a subscription on Google Play Store requires calling [updatePurchase()](making-purchases#3-update-purchases-android-only) function. When upgrading or downgrading a subscription, you can set the proration mode, or how the change affects your subscribers. You can find more information about the proration mode in the following [documentation](google-upgrade-downgrade-or-change-subscription).
