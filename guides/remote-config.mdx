...
![](/guides/images/docs/3dd5f7f-Screenshot_2024-03-25_at_13.43.35.png)
...
![](/guides/images/docs/fb54100-Screenshot_2024-03-25_at_14.03.36.png)
...
<Info>
  ...
  Qonversion Remote Configs and Experiments share single methods to get configurations. You can distinguish the source of the result received by looking at the *source* field. [Learn more about fields available](remote-config#remoteconfig-fields-description).
</Info>
...
* Qonversion assigns eligible users to launched experiments once the `remoteConfig` is called. We also recommend paying attention to the [Segmentation rules](remote-config#2-segment-users) for the configuration.

# 4. Test changes before launch

<Info>
  Please, note, the guide below allows you to test only configurations created through the [Remote Config dashboard section](https://dash.qonversion.io/remote-configs). To test configurations from the [Experiments section](https://dash.qonversion.io/ab-testing), please, follow the [test experimental changes before launch](launch-experiments#test-experimental-changes-before-launch) guide.
</Info>
...
![](/guides/images/docs/3b597ba-Screenshot_2024-03-25_at_14.04.58.png)
...
![](/guides/images/docs/77d8b42-Screenshot_2024-03-25_at_14.06.10.png)
...
![](/guides/images/docs/170933e-Screenshot_2024-03-25_at_14.07.13.png)

# 7. Fallback files (optional)

To enhance the reliability of remote configurations, consider utilizing Qonversion [fallback files](system-reliability#/fallback-files). These files will serve as a backup in case of network provider errors or system failures, ensuring that your application continues to receive essential data and avoids any downtime. For more information on fallback files and how to install them, please refer to [this page](system-reliability#/fallback-files).
