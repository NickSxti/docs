...
2. In [Settings](https://dash.qonversion.io/project/settings), select the platform for your app and provide platform-specific data:
   ...
   * **IOS App**:
     ...
     1. App-Specific Shared secret, you can find more details [here](app-specific-shared-secret)
   ...
   * **Android App**:
     ...
     1. Service Account Key credentials, you can find more details [here](service-account-key-android).
     2. Android package name

   * **Stripe App**: Please follow [this guide](stripe-integration) to connect Stripe to Qonversion

3. Get your Qonversion project key. You can find your Qonversion project key in the [Settings](https://dash.qonversion.io/project/settings) section of Qonversion. You will need this key to [configure the SDKs](quickstart).

![](/guides/images/docs/a887265-Frame_1000002684.png)
...
<Info>
  ...
  If you are building an app for kids, it is necessary to follow policies and do not collect IDFA, GAID and other advertisement attributes. For Kids Mode SDK integration follow [this guide](kids-mode-sdk).
</Info>

## 4. Implement Analytics or Subscription Management Mode

Please check the mode you prefer according to the [first step](quickstart#1-choose-qonversion-mode-you-want-to-implement) of this guide and follow the required option:
