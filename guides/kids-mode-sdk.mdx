...
<Warning>
  ...
  Cross-platform SDKs support Kids Mode only for the Android part. If you need a cross-platform SDK that supports Kids Mode for iOS, please get in touch with us using Intercom chat or [the following email address](/guides/cdn-cgi/l/email-protection#670f0e27160809110215140e0809490e08).
</Warning>
