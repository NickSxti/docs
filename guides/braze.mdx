...
3. Attribute events sent from Qonversion and events received from the Braze SDK to the same user by setting the same user id to Braze that you set to Qovnersion SDK in [User Identifiers guide](user-identifiers#2-user-id-for-third-party-integrations).
...
![](/guides/images/docs/8a34801-Braze_integration.png)
