...
<CardGroup style="--CardsGrid-cardWidth:200px;--CardsGrid-columns:3">
  <Card title="iOS SDK" href="/guides/ios-sdk-setup">

  </Card>

  <Card title="Android SDK" href="/guides/android-sdk">

  </Card>

  <Card title="Flutter SDK" href="/guides/flutter-sdk">

  </Card>

  <Card title="React Native SDK" href="/guides/react-native-sdk">

  </Card>

  <Card title="Unity SDK" href="/guides/unity-sdk">

  </Card>

  <Card title="Cordova Plugin" href="/guides/cordova">

  </Card>

  <Card title="Capacitor Plugin" href="/guides/capacitor">

  </Card>

  <Card title="Web SDK" href="/guides/web-sdk">

  </Card>

  <Card title="macOS / Catalyst" href="/guides/macos-catalyst">
