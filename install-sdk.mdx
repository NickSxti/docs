...
<CardGroup style="--CardsGrid-cardWidth:200px;--CardsGrid-columns:3">
  <Card title="iOS SDK" href="/ios-sdk-setup">

  </Card>

  <Card title="Android SDK" href="/android-sdk">

  </Card>

  <Card title="Flutter SDK" href="/flutter-sdk">

  </Card>

  <Card title="React Native SDK" href="/react-native-sdk">

  </Card>

  <Card title="Unity SDK" href="/unity-sdk">

  </Card>

  <Card title="Cordova Plugin" href="/cordova">

  </Card>

  <Card title="Capacitor Plugin" href="/capacitor">

  </Card>

  <Card title="Web SDK" href="/web-sdk">

  </Card>

  <Card title="macOS / Catalyst" href="/macos-catalyst">
